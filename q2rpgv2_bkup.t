...
loop
    ...
    if choice = "1" then
        ...
        loop
            ...
            put "                 Experience Chart"
            put "              ----------------------"
            put "              Dexterity       : LV ", plalvl (1)
            put "              Strength        : LV ", plalvl (2)
            put "              Karma           : LV ", plalvl (3)
            put "              Spirit          : LV ", plalvl (4)
            put "              Rage            : LV ", plalvl (5)
            put "              Wisdom          : LV ", plalvl (6)
            put "              Technical       : LV ", plalvl (7)
            put "              Munition        : LV ", plalvl (8)
            put "              Vitality Health : LV ", plalvl (9)
            put "              Vitality Armor  : LV ", plalvl (10)
        ...
        put "                 Experience Chart"
        put "              ----------------------"
        put "              Bide            : LV ", wpnlvl (1)
        put "              Spiral          : LV ", wpnlvl (2)
        put "              Expack          : LV ", wpnlvl (3)
        put "              Throw           : LV ", wpnlvl (4)
        put "              Power Anti      : LV ", wpnlvl (5)
